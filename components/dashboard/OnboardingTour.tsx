...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "Already have a name? Switch to Agent Lookup on the Search page and type any agent or agency name. The engine searches the open web — no Google Business listing required — and scores them the same way a market sweep does.",
    tip: "Useful when a referral gives you a name, or you spot someone on LinkedIn before running a full market scan.",
    tipTag: 'USE CASE',
    tipColor: '#ff5500',
    spotlightPadding: 10,
  },
  {
    ...
    body: "Every agent you search or look up gets saved here automatically. Filter by state, HOT/WARM/COLD flag, YouTube presence, hiring status. This is your growing CRM — it gets more powerful with every search you run.",
