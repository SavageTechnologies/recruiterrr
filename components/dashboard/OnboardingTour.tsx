...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    tagColor: '#aaaaaa',
    headline: 'BILLING.',
    body: "Hit the BILLING button in the nav to manage your plan, update payment, or download receipts. Your subscription is fully active right now.",
  },
  {
    id: 'anathema',
    ...
    tagColor: '#00e676',
    headline: 'ANATHEMA.',
    body: "Run a deep pathogen scan on a single agent — website, carrier affiliations, social presence, hiring signals. It tells you exactly what captive stage they're in and how to approach them.",
