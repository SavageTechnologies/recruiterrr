...
const STEPS: TourStep[] = [
  ...
  {
    id: 'david',
    target: '.dash-nav-item[href="/dashboard/david"]',
    position: 'right',
    tag: 'STEP 08',
    tagColor: 'var(--site-purple, #7c5cbf)',
    headline: 'DAVID.',
    body: "Personal intelligence on every agent Anathema has touched. Awards, content, social signals, career facts — the context your outreach needs to stop sounding generic and start getting replies.",
    tip: "Every fact David surfaces is something you can open a cold message with. The more Anathema scans you run, the richer your David profiles get.",
    tipTag: 'OUTREACH INTEL',
    tipColor: '#7c5cbf',
    spotlightPadding: 8,
  },
  {
    ...
    tagColor: 'var(--orange)',
    headline: "YOU'RE\nREADY.",
    body: "Search → Score → Scan → Pitch → Close. Start with Search, pick a city you know, and run your first market. Every tool builds on the last — the more you use the platform, the sharper your intelligence gets.",
    tip: "Anathema tells you who they are. Prometheus tells you who you're up against. David tells you how to open the conversation.",
    tipTag: 'WORKFLOW',
    tipColor: 'var(--orange)',
  },
]
