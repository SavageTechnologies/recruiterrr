  ...
  return (
    <>
      <nav style={{
        ...
        {/* Desktop nav */}
        <div className="page-nav-desktop" style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
      ...
      <style>{`
        @media (max-width: 639px) {
          .page-nav-desktop { display: none !important; }
          .page-nav-hamburger { display: flex !important; }
          .page-nav-overlay { display: flex !important; }
        }
      `}</style>
    </>
  )
