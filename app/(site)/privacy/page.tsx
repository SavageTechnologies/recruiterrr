...
const SECTIONS = [
  { title: 'What We Collect', body: 'When you create an account, we collect your name and email address. When you use the platform, we store your search activity and results so you can access them from your dashboard. Billing information is handled entirely by our payment processor — we never see or store your card details.' },
  { title: 'How We Use It', body: 'We use your data to operate the platform, surface your search history, and improve the product over time. We use aggregate, anonymized usage patterns to understand how the product is being used. We do not sell, rent, or share your personal data with third parties for marketing purposes — ever.' },
  ...
  { title: 'Data Security', body: 'All data is encrypted in transit and at rest. Access controls are enforced at the database level so your data is isolated from other users. We maintain security best practices throughout the stack.' },
  { title: 'Data Deletion', body: 'You can request deletion of your account and all associated data at any time by emailing support@recruiterrr.com. We will process all deletion requests within 30 days.' },
